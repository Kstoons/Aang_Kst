...
Hi {}, my name is {}! 
I am best and powerful bot.
You can find my list of available commands with /help.

This bot is created for maintenance of groups.😘😘
...
Supporting him; [Creator](t.me/ksfounder)"""
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup([
                  [InlineKeyboardButton(text="😉😉 Add Aang to your group", url="t.me/{}?startgroup=true".format(context.bot.username))],
                  [InlineKeyboardButton(text="❓ Help", callback_data="help_back")]]))
    else:
        update.effective_message.reply_text("Hi , Boss How are u still am alive only 🤔🤔")
